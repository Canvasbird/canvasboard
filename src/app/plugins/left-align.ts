...
export class AddLeftAlignComponent implements PluginComponent {
    ...
    addHTMLCode(uid) {
      ...
      <!-- H1 tag -->
      <div class="tool box1 mx-1" style="margin-bottom:5px;" title="Left Align">
        <button class="btn btn-light d-flex align-items-center w-100" id="add-left-align-box2-${uid}" style="padding: 0.05rem 0.75rem;">
          ...
          <span class="pl-2">Left Align</span>
        </button>
      </div>
      `);
    }
