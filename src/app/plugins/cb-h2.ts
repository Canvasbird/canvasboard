...
export class AddH2Component implements PluginComponent {
    ...
    addHTMLCode = (uid) => {
      ...
      <!-- h2 tag -->
      <div class="tool box2 mx-1" style="margin-bottom:5px;" title="H2">
        <button class="btn btn-light d-flex align-items-center w-100" id="add-h2-box2-${uid}" style="padding: 0.05rem 0.75rem;">
          <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-type-h2" fill="currentColor"
            xmlns="http://www.w3.org/2000/svg">
            <path
              d="M7.638 13V3.669H6.38V7.62H1.759V3.67H.5V13h1.258V8.728h4.62V13h1.259zm3.022-6.733v-.048c0-.889.63-1.668 1.716-1.668.957 0
