...
export class AddBlueBackgroundComponent implements PluginComponent {
    ...
    <!-- Blue Background color button -->
          <div class="tool box1 mx-1" style="margin-bottom:5px;" title="Blue Background">
            <button class="btn btn-primary d-flex align-items-center w-100" id="add-background-cb-blue-${uid}" style="padding: 0.05rem 0.75rem;">
