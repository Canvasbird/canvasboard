...
export class AddGreenBackgroundComponent implements PluginComponent {
    ...
    addHTMLCode = (uid) => {
     ...
     <!-- Green Background color button -->
            <div class="tool box1 mx-1" style="margin-bottom:5px;" title="Green Background">
            <button class="btn btn-success d-flex align-items-center w-100" id="add-background-cb-green-${uid}" style="padding: 0.05rem 0.75rem;">
              ...
              <span class="pl-2 text-white">Green Background</span>
            </button>
          </div>
    `);
    };
