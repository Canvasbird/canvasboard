...
export class AddTopComponent implements PluginComponent {
    ...
    addHTMLCode(uid) {
        $(`#cb-buttons-${uid}`).append(`
          <!-- top -->
            <div class="tool box5 mx-1" style="margin-bottom:5px;"  title="Add Card Top">
              <button class="btn btn-light d-flex align-items-center w-100" id="add-new-box-prev-${uid}" style="padding: 0.05rem 0.75rem;">
                ...
                <span class="pl-2">Add Card Top</span>
              </button>
            </div>
      `);
    }
