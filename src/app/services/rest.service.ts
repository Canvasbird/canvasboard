...
export class RestService {
    ...
    async createBoardData(boardData): Promise<NewBoard> {
        ...
        await this.http
            .post(
                'https://api.canvasboard.live/api/v1/user/folder/create-file',
                body,
                {
            ...
            .then((response) => {
                ...
                this.createFileResponse = JSON.parse(
    ...
    async saveBoardData(boardData) {
        ...
        await this.http
            .post(
                'https://api.canvasboard.live/api/v1/user/folder/edit-file',
                body,
                {
                    headers: new HttpHeaders({
                        'X-AUTH-TOKEN': this.xAuthToken,
    ...
    async getBoardData(boardId) {
        this.xAuthToken = localStorage.getItem('token');
        await this.http
            .get(`https://api.canvasboard.live/api/v1/user/files/${boardId}`, {
                headers: new HttpHeaders({
                    'X-AUTH-TOKEN': this.xAuthToken,
                }),
            })
    ...
    async deleteFile(folderId, fileId) {
        ...
        await this.http
            .delete(
                `https://api.canvasboard.live/api/v1/user/folder/remove-file?folder_id=${folderId}&file_id=${fileId}`,
                {
                    headers: new HttpHeaders({
                        'X-AUTH-TOKEN': this.xAuthToken,
                    }),
    ...
    async renameFile(body) {
        ...
        await this.http
            .post(
                `https://api.canvasboard.live/api/v1/user/folder/rename-file`,
                body,
                {
                    headers: new HttpHeaders({
                        'X-AUTH-TOKEN': this.xAuthToken,
    ...
    async getFoldersData() {
        this.xAuthToken = localStorage.getItem('token');
        await this.http
            .get(`https://api.canvasboard.live/api/v1/user/view-folders/`, {
                headers: new HttpHeaders({
                    'X-AUTH-TOKEN': this.xAuthToken,
                }),
            })
    ...
    async createFolder(body) {
        ...
        await this.http
            .post(
                `https://api.canvasboard.live/api/v1/user/create-folder`,
                body,
                {
                    headers: new HttpHeaders({
                        'X-AUTH-TOKEN': this.xAuthToken,
    ...
    async deleteFolder(value) {
        ...
        await this.http
            .delete(
                `https://api.canvasboard.live/api/v1/user/remove-folder?folder_id=${value}`,
                {
                    headers: new HttpHeaders({
                        'X-AUTH-TOKEN': this.xAuthToken,
                    }),
    ...
    async renameFolder(body) {
        ...
        await this.http
            .post(
                `https://api.canvasboard.live/api/v1/user/rename-folder`,
                body,
                {
                    headers: new HttpHeaders({
                        'X-AUTH-TOKEN': this.xAuthToken,
    ...
    async getFilesData(id) {
        ...
        await this.http
            .get(
                `https://api.canvasboard.live/api/v1/user/folder/files/${id}`,
                {
                    headers: new HttpHeaders({
                        'X-AUTH-TOKEN': this.xAuthToken,
                    }),
            ...
            .get(
                'https://quotes-inspirational-quotes-motivational-quotes.p.rapidapi.com/quote',
                {
                    headers: new HttpHeaders({
                        ...
                        'x-rapidapi-key':
                            '318ed0c148msh279b4a7589d2c18p1db725jsnaa114ac4aa88',
                        'x-rapidapi-host':
    ...
    async sendEmailAddressForReset(body) {
        try {
            await this.http
                .post(`https://api.canvasboard.live/api/v1/forget`, body)
                .toPromise()
                .then((response) => {
    ...
    async sendNewPasswordDetails(body) {
        try {
            await this.http
                .post(`https://api.canvasboard.live/api/v1/reset`, body)
                .toPromise()
                .then((response) => {
